  ...
  return (
    <div className="min-h-screen bg-[#E6F7FF] text-[#1D2D5D] px-6 py-12 font-sans">
      ...
      <header className="text-center mb-12">
        <img src="/monster-ag-logo.png" alt="Monster AG Logo" className="w-48 h-48 mx-auto mb-4 object-contain" />
        ...
        <p className="text-lg text-gray-700 mt-2 max-w-xl mx-auto">
          Lade deine Datenschutzerklärung hoch oder gib deine Website an – wir analysieren automatisch & anonym auf DSGVO-Verstöße.
        </p>
      </header>
      ...
      <section className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-12">
        <div className="bg-white rounded-xl shadow p-6 text-center">
          ...
          <p className="text-sm text-gray-600">DSGVO-Konformität deiner Seite – geprüft, bewertet und dokumentiert.</p>
        </div>
        <div className="bg-white rounded-xl shadow p-6 text-center">
          <AlertTriangle className="w-8 h-8 text-[#FF9900] mx-auto mb-3" />
          <h2 className="text-xl font-semibold mb-2">E-Mail</h2>
          <p className="text-sm text-gray-600">Gib deine E-Mail-Adresse an – du erhältst automatisch deine Bewertung.</p>
        </div>
        <div className="bg-white rounded-xl shadow p-6 text-center">
          <CheckCircle className="w-8 h-8 text-green-500 mx-auto mb-3" />
          <h2 className="text-xl font-semibold mb-2">Ergebnis</h2>
          <p className="text-sm text-gray-600">Ampel-Logik mit Ergebnis-PDF & Mail-Trigger (automatisiert oder manuell).</p>
        </div>
      </section>
